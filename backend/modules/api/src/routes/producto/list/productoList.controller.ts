...
export class ProductoListController {
  ...
  public list = async (
    ...
    try {
      const { activo, tiene_variantes, tipo_producto_id, coleccion_id } = req.query;
      const filters: any = {};

      if (activo !== undefined) filters.activo = activo === "true";
      if (tiene_variantes !== undefined) filters.tiene_variantes = tiene_variantes === "true";
      if (tipo_producto_id) filters.tipo_producto_id = tipo_producto_id as string;
