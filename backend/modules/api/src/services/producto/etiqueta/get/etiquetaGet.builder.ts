...
import { EtiquetaGetService } from "./etiquetaGet.service";

export class EtiquetaGetServiceBuilder {
  ...
  build(): EtiquetaGetService {
    ...
    return new EtiquetaGetService(this.supabaseClient);
  }
}
