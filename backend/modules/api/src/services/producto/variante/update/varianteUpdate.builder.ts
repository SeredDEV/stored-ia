...
import { VarianteUpdateService } from "./varianteUpdate.service";

export class VarianteUpdateServiceBuilder {
  ...
  build(): VarianteUpdateService {
    ...
    return new VarianteUpdateService(this.supabaseClient);
  }
}
