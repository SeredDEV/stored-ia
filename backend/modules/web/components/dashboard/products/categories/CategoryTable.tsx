    ...
    () => [
      ...
      columnHelper.accessor("status", {
            ...
            <span className="text-xs uppercase tracking-wider text-gray-500 dark:text-gray-400 font-semibold">
              <div className="flex items-center gap-2">
                ...
                <div className="relative group/select">
                   <select
                    className="appearance-none bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700 rounded-full text-xs font-medium py-1 pl-2.5 pr-6 text-gray-600 dark:text-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500/20 cursor-pointer transition-colors border-none"
        ...
        cell: (info) => {
          ...
          return (
            <div className="flex items-center gap-2">
              <span className={`w-2 h-2 rounded-full ${status === 'Activa' ? 'bg-green-500' : 'bg-gray-400'}`}></span>
      ...
      columnHelper.accessor("visibility", {
        ...
        cell: (info) => {
          ...
          return (
             <div className="flex items-center gap-2">
              <span className={`w-2 h-2 rounded-full ${visibility === 'Pública' ? 'bg-green-500' : 'bg-yellow-500'}`}></span>
